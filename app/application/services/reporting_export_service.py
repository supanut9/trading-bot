    ...
    def export_backtest_summary_csv(self) -> str:
        ...
        writer.writerow(
            [
                ...
                result.benchmark_realized_pnl,
                result.benchmark_return_pct,
                result.benchmark_excess_return_pct,
                result.slippage_pct,
                result.fee_pct,
                result.spread_pct,
                result.signal_latency_bars,
                list(result.allowed_weekdays_utc),
                list(result.allowed_hours_utc),
                result.max_volume_fill_pct,
                result.allow_partial_fills,
                result.assumption_summary,
        ...
        for run in self._backtest_runs.list_recent(limit=limit):
            writer.writerow(
                [
                    ...
                    run.benchmark_realized_pnl,
                    run.benchmark_return_pct,
                    run.benchmark_excess_return_pct,
