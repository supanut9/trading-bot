...
7. `feature/backtest-market-friction-hardening` — add spread, latency, partial-fill, and assumption-summary realism to replay results, run history, and operator controls (in progress)
